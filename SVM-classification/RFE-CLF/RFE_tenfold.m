function [acc_m,sen_m,spc_m,AUC,auc_curve,acc_max_index] = RFE_tenfold(data,label)
acc = zeros(100,1);
sen = zeros(100,1);
spc = zeros(100,1);
...
for i = 1:10
    ...
    for j = 1:10
        ...
        [acc1,sen1,spc1,dec_value,index_final]=getBestAcc_f(train,test,train_label,test_label);
